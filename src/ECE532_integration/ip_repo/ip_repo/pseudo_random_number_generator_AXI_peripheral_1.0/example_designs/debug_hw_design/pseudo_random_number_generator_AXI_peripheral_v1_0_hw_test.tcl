# Runtime Tcl commands to interact with - pseudo_random_number_generator_AXI_peripheral_v1_0

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/pseudo_random_number_generator_AXI_peripheral_v1_0_include.tcl
